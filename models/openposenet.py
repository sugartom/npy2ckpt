...
class OpenPose(Network):
    def setup(self):
        (self.feed('image')
             ...
             .conv(1, 1, 28, 1, 1, relu=False, name='conv5_5_CPM_L1'))
        ...
        (self.feed('conv4_4_CPM')
             ...
             .conv(1, 1, 16, 1, 1, relu=False, name='conv5_5_CPM_L2'))
        ...
        (self.feed('conv5_5_CPM_L1', 
             ...
             .conv(1, 1, 28, 1, 1, relu=False, name='Mconv7_stage2_L1'))
        ...
        (self.feed('concat_stage2')
             ...
             .conv(1, 1, 16, 1, 1, relu=False, name='Mconv7_stage2_L2'))
        ...
        (self.feed('Mconv7_stage2_L1', 
             ...
             .conv(1, 1, 28, 1, 1, relu=False, name='Mconv7_stage3_L1'))
        ...
        (self.feed('concat_stage3')
             ...
             .conv(1, 1, 16, 1, 1, relu=False, name='Mconv7_stage3_L2'))
        ...
        (self.feed('Mconv7_stage3_L1', 
             ...
             .conv(1, 1, 28, 1, 1, relu=False, name='Mconv7_stage4_L1'))
        ...
        (self.feed('concat_stage4')
             ...
             .conv(1, 1, 16, 1, 1, relu=False, name='Mconv7_stage4_L2'))

        (self.feed('Mconv7_stage4_L2', 
                   'Mconv7_stage4_L1')
